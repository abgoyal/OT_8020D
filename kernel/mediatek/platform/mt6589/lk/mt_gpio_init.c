...
u16 gpio_init_sim1_2_data[] = {
 ((GPIO44_DATAINV  << 0) |(GPIO45_DATAINV  << 1) |(GPIO46_DATAINV  << 2) |(GPIO44_PULLEN   << 4) |(GPIO45_PULLEN   << 5) |(GPIO46_PULLEN   << 6) |(GPIO44_PULL     << 8) |(GPIO45_PULL     << 9) |(GPIO46_PULL     << 10)),
}; /*end of gpio_init_mode_more_data*/

u16 gpio_init_sim2_2_data[] = {
 ((GPIO47_DATAINV  << 0) |(GPIO48_DATAINV  << 1) |(GPIO49_DATAINV  << 2) |(GPIO47_PULLEN   << 4) |(GPIO48_PULLEN   << 5) |(GPIO49_PULLEN   << 6) |(GPIO47_PULL     << 8) |(GPIO48_PULL     << 9) |(GPIO49_PULL     << 10)),
}; /*end of gpio_init_mode_more_data*/
...
u16 gpioext_init_dir_data[] = {
    ...
    ((GPIOEXT32_DIR      <<  0) |(GPIOEXT33_DIR      <<  1) |(GPIOEXT34_DIR      <<  2) |(GPIOEXT35_DIR      <<  3) |
     ...
     (GPIOEXT40_DIR      <<  8) |(GPIOEXT41_DIR      <<  9) |(GPIOEXT42_DIR      << 10) |(GPIOEXT43_DIR      << 11) |
     (GPIOEXT44_DIR      << 12) |(GPIOEXT45_DIR      << 13) |(GPIOEXT46_DIR      << 14) |(GPIOEXT47_DIR      << 15)),
...
u16 gpioext_init_pullen_data[] = {
    ...
    ((GPIOEXT32_PULLEN   <<  0) |(GPIOEXT33_PULLEN   <<  1) |(GPIOEXT34_PULLEN   <<  2) |(GPIOEXT35_PULLEN   <<  3) |
     ...
     (GPIOEXT40_PULLEN   <<  8) |(GPIOEXT41_PULLEN   <<  9) |(GPIOEXT42_PULLEN   << 10) |(GPIOEXT43_PULLEN   << 11) |
     (GPIOEXT44_PULLEN   << 12) |(GPIOEXT45_PULLEN   << 13) |(GPIOEXT46_PULLEN   << 14) |(GPIOEXT47_PULLEN   << 15)),
...
u16 gpioext_init_pullsel_data[] = {
    ...
    ((GPIOEXT32_PULL     <<  0) |(GPIOEXT33_PULL     <<  1) |(GPIOEXT34_PULL     <<  2) |(GPIOEXT35_PULL     <<  3) |
     ...
     (GPIOEXT40_PULL     <<  8) |(GPIOEXT41_PULL     <<  9) |(GPIOEXT42_PULL     << 10) |(GPIOEXT43_PULL     << 11) |
     (GPIOEXT44_PULL     << 12) |(GPIOEXT45_PULL     << 13) |(GPIOEXT46_PULL     << 14) |(GPIOEXT47_PULL     << 15)),
...
u16 gpioext_init_dinv_data[] = {
    ...
    ((GPIOEXT32_DATAINV  <<  0) |(GPIOEXT33_DATAINV  <<  1) |(GPIOEXT34_DATAINV  <<  2) |(GPIOEXT35_DATAINV  <<  3) |
     ...
     (GPIOEXT40_DATAINV  <<  8) |(GPIOEXT41_DATAINV  <<  9) |(GPIOEXT42_DATAINV  << 10) |(GPIOEXT43_DATAINV  << 11) |
     (GPIOEXT44_DATAINV  << 12) |(GPIOEXT45_DATAINV  << 13) |(GPIOEXT46_DATAINV  << 14) |(GPIOEXT47_DATAINV  << 15)),
...
u16 gpioext_init_dout_data[] = {
    ...
    ((GPIOEXT32_DATAOUT  <<  0) |(GPIOEXT33_DATAOUT  <<  1) |(GPIOEXT34_DATAOUT  <<  2) |(GPIOEXT35_DATAOUT  <<  3) |
     ...
     (GPIOEXT40_DATAOUT  <<  8) |(GPIOEXT41_DATAOUT  <<  9) |(GPIOEXT42_DATAOUT  << 10) |(GPIOEXT43_DATAOUT  << 11) |
     (GPIOEXT44_DATAOUT  << 12) |(GPIOEXT45_DATAOUT  << 13) |(GPIOEXT46_DATAOUT  << 14) |(GPIOEXT47_DATAOUT  << 15)),
...
u16 gpioext_init_mode_data[] = {
    ...
    ((GPIOEXT40_MODE     <<  0) |(GPIOEXT41_MODE     <<  3) |(GPIOEXT42_MODE     <<  6) |(GPIOEXT43_MODE     <<  9) |(GPIOEXT44_MODE     << 12)),
    ((GPIOEXT45_MODE     <<  0) |(GPIOEXT46_MODE     <<  3) |(GPIOEXT47_MODE     <<  6) |(GPIOEXT48_MODE     <<  9) ),
...
void mt_gpio_set_default_chip(void)
{
    ...
    for (idx = 0; idx < sizeof(pReg->pullen)/sizeof(pReg->pullen[0]); idx++){
		...
		if((idx >= 7) && (idx <= 10)){
			GPIO_WR32(&pReg1->pullen[idx],val);
		}
    ...
    for (idx = 0; idx < sizeof(pReg->pullsel)/sizeof(pReg->pullsel[0]); idx++){ 
		...
		if((idx >= 7) && (idx <= 10)){
			GPIO_WR32(&pReg1->pullsel[idx],val);
		}
...
#define GPIO_BIAS_KEY_ADDR (0x1020c000 + 0x920)
	...
	mt_gpio_set_dsel(GPIO_DVDD28_NML2,GPIO_DVDD28_BSI,GPIO_DVDD28_BPI);
...
void mt_gpio_checkpoint_compare_ext(void)
{
    ...
    if (memcmp(&latest, &saved_ext, sizeof(GPIOEXT_REGS))) {
        ...
        //mt_gpio_dump(&latest);
        GPIODBG("\n\n");
        mt_gpio_dump_dif_ext(&saved_ext, &latest);        
        //WARN_ON(1);
    } else {
