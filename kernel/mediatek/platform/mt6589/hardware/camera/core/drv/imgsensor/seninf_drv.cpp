...
//
    ...
    *pCMMCLKReg = ( (*pCMMCLKReg)&(~0x07) ) | 0x01;
    ...
    //*(mpSENINFClearGateRegAddr) |= 0x000001FF;
       ...
       //set CMMCLK mode 1
	   //[begin]456653 zhfan 2013-6-10 for imx135 and imx132 power sequence set CMMCLK mode 0
...
)
{
    ...
    SENINF_WRITE_BITS(pSeninf, SENINF_TG1_PH_CNT, ADCLK_EN, 0);//FPGA experiment
	//[end]456653 zhfan 2013-6-10
