...
#define LCD_LDO_ENN_GPIO_PIN          							(GPIO148)
#define LCD_LDO_ENP_GPIO_PIN          							(GPIO166)
...
static void lcm_init(void)
{
	...
	//SET_RESET_PIN(1);//rise edge for power on
	MDELAY(50);
...
static void lcm_suspend(void)
{
	...
	lcm_util.set_gpio_dir(GPIO131, GPIO_DIR_OUT); 
	lcm_util.set_gpio_pull_enable(GPIO131, GPIO_PULL_DISABLE); 
	lcm_util.set_gpio_out(GPIO131 , 0);//for LCD idle current= 3.8mA PR454011
...
LCM_DRIVER r63311_fhd_dsi_vedio_scribepro_lcm_drv =
{
